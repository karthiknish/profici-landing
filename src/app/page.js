    ...
    <div className="min-h-screen font-[family-name:var(--font-geist-sanxs)]">
      ...
      >
        ...
        >
          ...
          <motion.div
            className="w-full max-w-lg mx-auto mt-4 md:mt-0 md:absolute md:-top-10 md:left-1/2 md:ml-12 md:transform md:-translate-x-1/4"
            variants={fadeInUp}
          >
            <Globe />
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                description: "Utilising the latest in design and tech",
